...
ggmap::register_google(key = "AIzaSyC4KUNAiSMIvh5Qm4u1PbHY23CHnCII1Hk", write = TRUE)
...
```{r}
#| label: tbl-PROMimp
#| tbl-cap: "Summary of model-predicted QuickDASH and EQ5D (adjusted) by diagnostic group"
...
Mastersheet5 <- Mastersheet4 |> left_join(
  ...
  Cohort2 = case_when(
    ...
    str_detect(DiagnosisPrimary , "arthrop*|arthrosis") ~ "Glenohumeral Osteoarthritis",
    .default = Cohort
  ),
