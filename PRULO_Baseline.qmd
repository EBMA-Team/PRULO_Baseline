...
Patients presenting for surgical review at a regional orthopaedic private clinic are diverse in their demographics, residential location and pathology. The present results demonstrate significant differences in baseline patient experience prior to any offers of treatment that may help guide expectations for different diagnoses after surgery or non-surgical modalities. The present results provide a benchmark for future efforts in monitoring and mapping the response to treatment strategies in these varying patient groups in the Australian context.
