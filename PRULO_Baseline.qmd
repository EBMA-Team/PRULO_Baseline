...
The self-reported medical comorbidities questionnaire [@sangha2003] was manually rescored within the analysis with the text response columns provided with the registry snapshot.
...
Patient characteristics for cases are summarised in @tbl-characteristics. The distance between patient residence and the clinic location is summarised in the figure below.
