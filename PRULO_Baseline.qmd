...
Patient characteristics for cases are summarised in @tbl-characteristics. The distance between patient residence and the clinic location is summarised in the figure below. The straight-line distance (km) was log-transformed to enable visualisation.
...
Complete case analysis of the QuickDASH total score and EQ5D Index were summarised using the *gtsummary* package. A significant reduction in QuickDASH
...
Does it make a difference if subgroups (adhesive capsulitis and glenohumeral osteoarthritis) are split from the general cohort. Regular expressions were used in the *stringr* package to identify diagnosis codes that match two of the higher-incidence diagnoses, that are categorised under the General diagnostic group (adhesive capsulitis; glenohumeral osteoarthritis) as indicated in @tbl-diagnosis.
